...
public class CorsConfig implements WebMvcConfigurer {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173","http://vps-5038974-x.dattaweb.com",
        "https://laburbujafeliz.com","http://laburbujafeliz.com")); // Origen permitido
